#
#  Be sure to run `pod spec lint ESAlbumManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "ESAlbumManager"
  s.version      = "0.0.2"
  s.summary      = "albumManager for iOS"
  ...
  s.source       = { :git => "https://github.com/EverydayStep/ESAlbumManager.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ESAlbumManager/ESAlbumManager/*.{h,m}"
